...
A standalone implementation of the cluster jackknife estimator discussed in MNW is implemented in the [CRV3J package](https://github.com/s3alfisc/CRV3J).
...
```{r example, warning = FALSE, message = FALSE, out.width="50%"}
library(summclust)
